      ...
      <v-flex mb-3 xs12>
        <v-layout wrap>
          <p>
            ...
            I "shipped" to end users (one at a time
            <a href="https://www.amazon.com/Guerrilla-83Linkcable-Link-Cable-Calculators/dp/B008O7K9FW" target="_blank">via a single cable</a>).
          </p>
          <p>
            ...
            <a href="https://github.com/mirajp/malicious-news-classification" target="_blank">weeding out fake/maliciously-authored "news" articles</a>.
          </p>
          <p>
