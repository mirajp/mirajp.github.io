      ...
      <v-flex mb-3 xs12>
        <v-layout wrap>
          <p>
            ...
            I "shipped" to my end users (one at a time
            <a href="https://www.amazon.com/Guerrilla-83Linkcable-Link-Cable-Calculators/dp/B008O7K9FW"
              target="_blank">via a single cable</a>).
          </p>
          <p>
            ...
            to SharePoint libraries/services to replace InfoPath forms, to interactive maps of NYC to find
            transformers and regions susceptible to electric outages). As my academic career progressed,
            I took a liking to machine learning, particularly artificial intelligence and natural language
            processing. The applications of AI, even "simple" AI models, were astounding. For example, you
            could tackle real-world problems like
            <a href="https://github.com/mirajp/malicious-news-classification"
              target="_blank">weeding out fake/maliciously-authored "news" articles</a>.
          </p>
          <p>
            I believe an engineer's real mission is to make life easier for each and every person.
            I became a software engineer to try to do just that.
          </p>
        </v-layout>
      </v-flex>
    </v-layout>
