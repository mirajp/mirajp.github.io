            ...
            >
              <template v-slot:header>
                <v-layout>
                  ...
                  <v-flex xs3 class="text--secondary experience-time"
                    >{{ experience.start }} - {{ experience.end }}</v-flex
                  >
                </v-layout>
              </template>
...
const experiences = [
  {
    ...
    iconColor: "primary",
    description: `
      - Web and experiment infrastructure for Marketing properties (<a href="https://ads.google.com/">Google Ads</a>, <a href="https://www.thinkwithgoogle.com/">Think with Google</a>) <br>
      - UI/UX/API development @ <a href="https://www.thinkwithgoogle.com/">Think with Google</a> <br>
      - Enhanced CMS capabilities for content and user feed personalization, user data management, and UX experimentation <br>
      - Managed stakeholder relations with data science and analytics leads, global PMMs, and vendor teams to launch and land high priority infrastructure improvements <br>
    `
  },
  {
  ...
  },
  {
    ...
    description: `
      ...
      - Built CI/CD pipelines on Azure DevOps for streamlined integration and UAT testing and release into multiple environments <br>
    `
  },
  {
    ...
    description: `
      ...
      - Optimized ETL procedures on SQL Server; reduced the runtime of audit-related backups by ~67% <br>
    `
  },
  {
    ...
    description: `
      ...
      Majored in Electrical Engineering and completed a Natural Language Processing-focused thesis to meet the requirements for an Electrical Engineering Master of Engineering degree. <br>
    `
  },
  {
    title: "ConEdison",
    ...
    description: `
      ...
      - Redesigned department's SharePoint site, document libraries, online forms, and Nintex workflows <br>
    `
  },
  {
    title: "High 5 Games",
    ...
    description: `
            ...
            - Created in-house productivity tools for speeding up time consuming processes involving localization and slot pay lines visualization <br>
        `
  },
  {
    ...
    description: `
            ...
            Majored in Electrical Engineering (the Computer Engineering track) and earned a Bachelor of Engineering degree. <br>
        `
  },
  {
    ...
    description: `
            ...
            - Digitized records of employees/contractors and environmental school site data reports for network accessibility and possible future litigation <br>
        `
  },
  {
    ...
    description: `
            ...
            AP Calculus BC, AP Statistics, AP Chemistry, AP Physics B, AP World History, AP US History, AP English Language, AP English Literature, AP Government <br>
        `
  },
  {
    ...
    description: `
            ...
            - Assisted customers with their needs, including teaching the customers how to use the library and all its resources <br>
        `
  }
];
...
function createMarker(map, place, locationRef, onClick) {
  const markerImage = {
    ...
    scaledSize: new google.maps.Size(...(locationRef.imageSize || [128, 128]))
  };
...
export default {
  ...
  methods: {
    ...
    onSelectionChange(selectedIndex) {
      ...
      this.map.setCenter(selectedExperience.location.place.geometry.location);
      this.map.setZoom(19);
